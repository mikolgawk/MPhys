...
for x in range(start_index, end_index + 1):
    try:
        name = 'band_structure_mp-' + str(x)
        BS_dir = 'C:/Users/Czaja/Desktop/MPhys thesis/Materials_project_picture_prep/venv/band_structure_jsons/'
        ...
        #Info about the elements ToDo: find the equivalent of that info in Materials Project
        """
        ...
        plt.axis('off')
        plt.margins(0, 0)
        directory = 'C:/Users/Czaja/Desktop/MPhys thesis/Materials_project_picture_prep/venv/band_structure_pictures/'
        outfile = directory + name + '.png'
